...
class AltoClassmap
{
    ...
    public static function getCollection() : \Phpro\SoapClient\Soap\ClassMap\ClassMapCollection
    {
        return new ClassMapCollection([
            ...
            new ClassMap('Data_eForm_TransferOfLandType', Type\Data_eForm_TransferOfLandType::class),
            ...
            new ClassMap('Data_eForm_Mortgage', Type\Data_eForm_Mortgage::class),
            ...
            new ClassMap('Data_eForm_Caveat', Type\Data_eForm_Caveat::class),
            new ClassMap('instrumentsType', Type\InstrumentsType::class),
            new ClassMap('Data_eForm_Discharge', Type\Data_eForm_Discharge::class),
            new ClassMap('Data_eForm_Universal', Type\Data_eForm_Universal::class),
