...
class CaveatorPartyGroupTypeTest extends AbstractSoapTest
{
    public function testObjectToString()
    {
        ...
        $this->assertEquals(
            sprintf('<Caveators><Caveator><GivenName>Nathanael</GivenName><Surname>Noblet</Surname><ExecutionDate>2018-02-22</ExecutionDate>%s</Caveator></Caveators>',$this->serialize($address,'Address')),
            $this->serialize($group,'Caveators'));
    }
}
